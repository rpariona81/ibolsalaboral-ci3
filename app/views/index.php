...
<head>
    ...
    <!-- PLUGINS CSS STYLE -->
    <link href="public/theme/assets/plugins/simplebar/simplebar.css" rel="stylesheet" />
    <link href="public/theme/assets/plugins/nprogress/nprogress.css" rel="stylesheet" />
    ...
    <link href='public/theme/assets/plugins/data-tables/datatables.bootstrap4.min.css' rel='stylesheet'>

    <link href='public/theme/assets/plugins/data-tables/jquery.datatables.min.css' rel='stylesheet'>

    <link href="public/theme/lib/css/data-table/buttons.bootstrap.min.css" rel="stylesheet" />
    <link href="public/theme/lib/css/data-table/buttons.dataTables.min.css" rel="stylesheet" />

    <!-- SLEEK CSS -->
    <link id="sleek-css" rel="stylesheet" href="public/theme/assets/css/sleek.css" />

    <!-- FAVICON -->
    <link href="public/theme/assets/img/favicon.png" rel="shortcut icon" />
    ...
    <![endif]-->
    <script src="public/theme/assets/plugins/nprogress/nprogress.js"></script>
</head>
                        ...
                        <ul class="nav navbar-nav">
                                                ...
                                                <ul class="list-unstyled" data-simplebar style="height: 360px">
                                                    <li>
                                                        <a href="javscript:void(0)" class="media media-message media-notification">
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle" src="public/theme/assets/img/user/u2.jpg" alt="Image">
                                                    ...
                                                    <li>
                                                        <a href="javscript:void(0)" class="media media-message media-notification media-active">
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle" src="public/theme/assets/img/user/u1.jpg" alt="Image">
                                                    ...
                                                    <li>
                                                        <a href="javscript:void(0)" class="media media-message media-notification">
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle" src="public/theme/assets/img/user/u5.jpg" alt="Image">
                                                                <span class="status away"></span>
                                                            </div>
                                                            <div class="media-body d-flex justify-content-between">
                                                                <div class="message-contents">
                                            ...
                                            <div class="tab-pane fade" id="profile2" role="tabpanel" aria-labelledby="profile2-tab">
                                                <ul class="list-unstyled" data-simplebar style="height: 360px">
                                                    <li>
                                                        <a href="javscript:void(0)" class="media media-message media-notification">
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle" src="public/theme/assets/img/user/u6.jpg" alt="Image">
                                                                <span class="status away"></span>
                                                            </div>
                                                            <div class="media-body d-flex justify-content-between">
                                                                <div class="message-contents">
                                                    ...
                                                    <li>
                                                        <a href="javscript:void(0)" class="media media-message media-notification">
                                                            <div class="position-relative mr-3">
                                                                <img class="rounded-circle" src="public/theme/assets/img/user/u7.jpg" alt="Image">
                                                                <span class="status away"></span>
                                                            </div>
                                                            <div class="media-body d-flex justify-content-between">
                                                                <div class="message-contents">
                            ...
                            <li class="dropdown user-menu">
                                <button href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <img src="public/theme/assets/img/user/user.png" class="user-image" alt="User Image" />
                                    <span class="d-none d-lg-inline-block">Abdus Salam</span>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <!-- User image -->
                                    <li class="dropdown-header">
                                        <img src="public/theme/assets/img/user/user.png" class="img-circle" alt="User Image" />
                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    <div class="expendable-data-table">
                                        ...
                                        <table id="expendable-data-table" class="table table-bordered table-hover" style="width:100%">
                                            <thead>
                                                <tr class="bg-warning">
                                                    <th></th>
                                                    <th>First name</th>
  ...
  $('#expendable-data-table tbody').on('click', 'td.details-control', function () {
    ...
    if ( row.child.isShown() ) {
      ...
      tr.addClass('shown');
                                            ...
                                            <pre class="mt-4">
<code>&lt;script src="public/theme/assets/plugins/data-tables/jquery.datatables.min.js"&gt;&lt;/script&gt;</code>
<code>&lt;script src="public/theme/assets/plugins/data-tables/datatables.bootstrap4.min.js"&gt;&lt;/script&gt;</code>
</pre>
                                        </div>
 ...
 &lt;/table&gt;
                                        ...
                                        <div class="tab-pane pt-3 fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                            <pre class="mt-4">
<code>&lt;script src="public/theme/assets/plugins/data-tables/jquery.datatables.min.css"&gt;&lt;/script&gt;</code>
<code>&lt;link href="public/theme/assets/plugins/data-tables/datatables.bootstrap4.min.css" rel="stylesheet"&gt;</code>
<code>&lt;link href=""https://unpkg.com/sleek-dashboard/dist/public/theme/assets/css/sleek.min.css"&gt;</code>
</pre>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- Javascript -->
    <script src="public/theme/assets/plugins/jquery/jquery.min.js"></script>
    <script src="public/theme/assets/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="public/theme/assets/plugins/simplebar/simplebar.min.js"></script>



    <script src='public/theme/assets/plugins/data-tables/jquery.datatables.min.js'></script>
    <script src='public/theme/assets/plugins/data-tables/datatables.bootstrap4.min.js'></script>

    <script src="public/theme/lib/js/data-table/dataTables.buttons.min.js"></script>
    <script src="public/theme/lib/js/data-table/buttons.flash.min.js"></script>
    <script src="public/theme/lib/js/data-table/jszip.min.js"></script>
    <script src="public/theme/lib/js/data-table/pdfmake.min.js"></script>
    <script src="public/theme/lib/js/data-table/vfs_fonts.js"></script>
    <script src="public/theme/lib/js/data-table/buttons.html5.min.js"></script>
    <script src="public/theme/lib/js/data-table/buttons.print.min.js"></script>



    <script src="public/theme/assets/js/sleek.js"></script>
